...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2020 at 09:33 PM
...
INSERT INTO `patientinfo` (`patientId`, `firstName`, `middleName`, `lastName`, `age`, `gender`, `email`, `phoneNo`, `address`, `zone`, `woreda`, `region`, `country`, `natureOfJob`, `preDisease`, `admittedOn`, `travelHistory`, `contactWithCases`, `presentStatus`, `ecfirstName`, `relationShip`, `ecAddress`, `ecPhoneNo`, `ecEmail`, `allergies`, `medications`, `operation1`, `doo1`, `operation2`, `doo2`, `operation3`, `doo3`, `familyHistory`, `smoke`, `pregnantRisk`, `symptoms`, `status`) VALUES
(6, 'Yosuf', 'adsfasdf', 'YZW', 6, 'Male', 'asd@gmail.com', 2462346464, 'Mettu', 'mettu', '01', 'Oromia', 'Ethiopia', 'Teaching', 'Nil', '2020-04-24', 'Nil', 'Yes', 'Critical', 'Dawid', 'Father', 'adfasdfadssdf', 5673651352, '', 'Nil', 'Nil', 'Nil', '', '', '', '', '', 'NO', 'Yes', 'No', 'Cough,Difficulty in breathing', 'active'),
...
(8, 'Ramesh', 'Kumar', 'krishna', 46, 'Male', 'ramesh@gmail.com', 4262463473, 'Mettu', 'mettu', '01', 'Oromia', 'India', 'Teaching', 'Nil', '2020-04-27', 'From Dubai', 'No', 'Normal', 'Dawid', 'Friend', 'Mettu', 9787687513, '', 'Nil', '', 'Heart', '2020-06-02', '', '', '', '', 'Nil', 'Yes', 'No', 'Cough,Pressure in the chest', 'active'),
(9, 'Demesa', '', 'Lema', 24, 'Male', 'demesa@gmail.com', 4262463473, 'Mettu', 'mettu', '01', 'Addis Ababa', 'Ethiopia', 'Teaching', 'Nil', '2020-04-23', 'Nil', 'Yes', 'Quarantined', 'Lema', 'Father', 'Mettu', 5673651352, 'adsf@gmail.com', 'Nil', 'Nil', '', '', '', '', '', '', 'NO', 'No', 'No', 'Cough,Sore throat', 'active'),
