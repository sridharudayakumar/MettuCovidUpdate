							...
							<div class="card-body p-0">
								...
								<div class="row">
									<div class="col-lg-6 d-none d-lg-block ">
										<img class="img-fluid px-2 px-sm-1 mt-4 mb-2" style=""
											src="img/password.jpg" alt="">
									</div>
									<div class="col-lg-6">
										<div class="p-5">
											<%
											...
											<form class="needs-validation user" action="ChangePassword"
												...
												<div class="form-group">
													...
													class="form-control"
														...
														placeholder="Enter Old Password.." value="" minlength="6"
														required="">
												</div>
												<div class="form-group">
													<input type=password "
													class="form-control"
														...
														placeholder="Enter New Password.." value="" minlength="6"
														required="">
												</div>
